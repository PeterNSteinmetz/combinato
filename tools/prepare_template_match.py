...
def main(preIctal_session, total_session, preIctal_label, joblist):#, channels):
    ...
    #for channel in channels:
        ...
        sorting_PreIctal_file=glob.glob(os.path.join(preIctal_session, channel,preIctal_label+'_*','sorting.h5'))
...
def transform_sorting(sorting_PreIctal_file, sorting_TemplateTimes_file, preIctal_file, totalSession_file): # input is clustered sorting.h5 of PreIctal and unclustered sorting.h5 of new Data
...
# save transformed data to sorting.h5
    try:
       ...
       sorting_TemplateTimes.create_array('/','artifact_scores',sorting_PreIctal.root.artifact_scores[:])
